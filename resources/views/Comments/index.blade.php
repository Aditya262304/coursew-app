<x-app-layout>
    ...
    @if (Auth::user()->type === "admin")
        ...
        <div class="m-8 p-6 bg-gray-200 border border-gray-200 rounded-lg shadow dark:bg-gray-200 dark:border-gray-700 w-4/5">
            ...
            <div class="mt-3 p-6 border border-gray-900 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <div class = "mb-3">
                        {{ $post->post }}
                </div>
                @if($post->image)
